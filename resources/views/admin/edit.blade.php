        ...
        <div class="row">
            <div class="col-sm-4">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="{{url('admin')}}">管理员修改</a></li>
            ...
            <div class="col-sm-8" style="float: right">
                ...
                <center>
                    ...
                    <form action="{{url('admin/update',["id"=>$admin->admin_id])}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="firstname" class="col-sm-2 control-label">名字</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="a" name="admin_name"
                                       value="{{$admin->admin_name}}"><span id="span_a"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="password" class="form-control" id="b" name="admin_pwd"
                                       value="{{$admin->admin_pwd}}"><span id="span_b"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="c" name="admin_tel"
                                       value="{{$admin->admin_tel}}"><span id="span_c"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="email" class="form-control" id="d" name="admin_email"
                                       value="{{$admin->admin_email}}"><span id="span_d"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <select name="admin_leven" id="">
                                    ...
                                    <option value="0" {{$admin->admin_leven==0?"selected":""}}>产品经理</option>
                                    <option value="1" {{$admin->admin_leven==1?"selected":""}}>业务员</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-7">
                                <button type="submit" id="f" class="form-control btn-primary">修改</button>
                            </div>
                        </div>
                    </form>
                </center>
